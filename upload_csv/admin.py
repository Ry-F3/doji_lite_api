...
@admin.register(LiveTrades)
class LiveTradesAdmin(admin.ModelAdmin):
    list_display = ('owner', 'asset', 'total_quantity', 'long_short', 'live_fill',
                    'live_price', 'live_pnl', 'live_percentage', 'last_updated', 'is_live')
    list_filter = ('owner', 'asset', 'is_live')
    search_fields = ('owner__username', 'asset')
